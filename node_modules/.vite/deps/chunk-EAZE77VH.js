...
var CompoundComponentContext = React10.createContext(null);
if (true) {
...
function useCompoundParent() {
  const [subitems, setSubitems] = React10.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React10.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React10.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React10.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React10.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React10.useCallback(function getItemIndex2(id) {
...
function useCompoundItem(id, itemMetadata) {
  const context = React11.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React11.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
//# sourceMappingURL=chunk-EAZE77VH.js.map
