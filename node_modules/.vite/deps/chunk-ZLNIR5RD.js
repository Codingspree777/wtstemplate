...
var TransitionContext = React5.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React6.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React7.useState(true);
  const hasPendingExitTransition = React7.useRef(false);
  const registeredTransitions = React7.useRef(0);
  const [hasTransition, setHasTransition] = React7.useState(false);
  const previousRequestEnter = React7.useRef(requestEnter);
  React7.useEffect(() => {
  ...
  const handleExited = React7.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React7.useCallback(() => {
...
var PopupContext = React8.createContext(null);
if (true) {
...
var Popup = React9.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React9.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var COMPONENT_NAME2 = "Select";
function getSelectUtilityClass(slot) {
  return generateUtilityClass(COMPONENT_NAME2, slot);
}
var selectClasses = generateUtilityClasses(COMPONENT_NAME2, ["root", "button", "listbox", "popup", "active", "expanded", "disabled", "focusVisible"]);

// node_modules/@mui/base/Select/Select.js
var import_jsx_runtime4 = __toESM(require_jsx_runtime());
var import_jsx_runtime5 = __toESM(require_jsx_runtime());
var _span;
var _excluded2 = ["areOptionsEqual", "autoComplete", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "required", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "placeholder", "slotProps", "slots", "value"];
...
var Select = React10.forwardRef(function Select2(props, forwardedRef) {
  ...
  const [buttonDefined, setButtonDefined] = React10.useState(false);
  ...
  const handleButtonRefChange = React10.useCallback((element) => {
  ...
  return (0, import_jsx_runtime5.jsxs)(React10.Fragment, {
    children: [(0, import_jsx_runtime4.jsx)(Button, _extends({}, buttonProps, {
    ...
    })), buttonDefined && (0, import_jsx_runtime4.jsx)(Popup, _extends({
      slots: {
        root: PopupComponent
      }
    }, popupProps, {
      children: (0, import_jsx_runtime4.jsx)(ListboxRoot, _extends({}, listboxProps, {
...
true ? Select.propTypes = {
   ...
   */
  areOptionsEqual: import_prop_types3.default.func,
  /**
   ...
   */
  getOptionAsString: import_prop_types3.default.func,
  /**
  ...
  slotProps: import_prop_types3.default.shape({
    ...
    popup: import_prop_types3.default.oneOfType([import_prop_types3.default.func, import_prop_types3.default.object]),
  ...
  slots: import_prop_types3.default.shape({
    ...
    popup: import_prop_types3.default.elementType,
...
//# sourceMappingURL=chunk-ZLNIR5RD.js.map
